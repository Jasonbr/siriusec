---
authors: Alexander Klizhentas (sasha@gosiriusec.com), Ben Arent (ben@gosiriusec.com)
state: implemented
---
...
Let's add missing features to Siriusec and use them to compose a solution
...
Siriusec Admin as part of Siriusec Setup.
https://gosiriusec.com/siriusec/docs/enterprise/sso/ssh-sso/.
...
Siriusec login screen will have a separate optional field: "Request access". Alice
clicks "Request access" expandable section and adds a note with a ticket number.

Once Alice enters a reason, Siriusec will create an `access_request` with note
...
Contractors will log in and enter the note / ticket number.  Siriusec will generate
...
## Audit Log
All request events will be tracked by Siriusecs Audit Log. These will recorded under
...
with extra meta data about its reason for who approved, or why it was denied. See (Siriusec Plugin)[https://github.com/siriusec/siriusec-plugins/blob/22334ec352bc62fc6bddd98f2284228442da73fb/access/access.go#L128] as an example.
