...
description: How to configure Siriusec Database Access with AWS RDS/Aurora PostgreSQL.
...
Siriusec Database Access for PostgreSQL on AWS is available starting from `6.0`
release.
