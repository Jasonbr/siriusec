---
authors: Alexander Klizhentas (sasha@gosiriusec.com)
state: implemented
---
...
native GRPC transport, because of the problems described [here](https://github.com/siriusec/oom).
...
This created performance and stability problems for large uploads, siriusec was consuming
...
In siriusec 4.3 and earlier some streams and sessions were never uploaded
