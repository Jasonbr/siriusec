...
description: Configuration reference for Siriusec Database Access.
---
...
appearing in `siriusec.yaml` configuration file:
...
>
  ...
  Do not set `--insecure-no-tls` for the proxy Siriusec instances as a parameter.  If you are terminating TLS at a
