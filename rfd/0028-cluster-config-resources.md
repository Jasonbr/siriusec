...
see [RFD 16](https://github.com/siriusec/siriusec/blob/master/rfd/0016-dynamic-configuration.md).
...
To fulfill the obligation of backward compatibility with respect to older Siriusec components, reading of `ClusterConfig` will remain supported:
...
### (Siriusec Cloud only) Restricting to a subset of values of a field
