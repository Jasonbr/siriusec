...
description: Connecting a Kubernetes cluster to Siriusec.
---
...
- Installed and running Siriusec Cluster

(!docs/pages/includes/helm.mdx!)

## Connecting clusters

Siriusec can act as an access plane for multiple Kubernetes clusters. 
We have set up the Siriusec cluster `tele.example.com` in [SSO and Kubernetes](../getting-started.mdx).
