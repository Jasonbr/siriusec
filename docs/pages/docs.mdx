...
- If you have an idea to improve the docs tooling, submit a ticket over in the [Next](https://github.com/siriusec/next) repo.
- If you have an idea to improve the docs (an article, post, example, etc.), submit a ticket over in the [Siriusec](https://github.com/siriusec/siriusec) repo.
...
This section ennumerates the most-common kinds of documents we write at Siriusec and include within our document set.
...
- These are *Tutorials* in [DIVIO parlance](https://www.divio.com/), articles designed for beginners, and often people who may not have heard about Siriusec before. This is one of the first interactions they'll have with the product so we want it to be stress-free and fun.
...
*Guides* are self-contained articles for intermediate readers (readers with some familiarity working with Siriusec already) setting up Siriusec for a specific scenario.

These are *How-To's* in [DIVIO parlance](https://www.divio.com/). They describe a way to use Siriusec for a specific purpose. Here, conceptual information is deprioritized and the hand-on ability to complete the objective is made paramount.
...
1. **Integration** - *integration guides* explain how to set up Siriusec with other tools. E.g. - "Access Requests with Slack".
...
*Architecture* articles explain how Siriusec works to advanced readers. Architects, devsecops, or similar professional constitute the most-common audience. 
...
- Whereas the former is concerned with how to use, find, or create something using Siriusec tools, the latter is concerned with the interaction of containers, nodes, security, and infrastructure.
