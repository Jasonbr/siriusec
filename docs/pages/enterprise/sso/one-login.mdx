...
Configure Siriusec auth server to use SAML authentication instead of the local
...
- [Square Icon](../../../img/sso/onelogin/siriusec.png)
- [Rectangular Icon](../../../img/sso/onelogin/siriuseclogo@2x.png)
...
>
  ...
  because siriusec only supports `SP` - service provider initiated SAML flows.
</Admonition>

Set `Audience`, `Recipient` and `ACS (Consumer) URL Validator` to the same value:

`https://siriusec.example.com:3080/v1/webapi/saml/acs` where `siriusec.example.com` is the
public name of the siriusec web proxy service:

![Configure SAML](../../../img/sso/onelogin/onelogin-saml-2.png)

Siriusec needs to assign groups to users. Configure the application with some parameters
...
- `acs` - is the name of the siriusec web proxy, e.g. `https://siriusec.example.com/v1/webapi/saml/acs`
...
<Admonition
  ...
  title="IMPORTANT"
>
  Siriusec only supports sending party initiated flows for SAML 2.0. This
...
![Siriusec](../../../img/sso/onelogin/onelogin-saml-8.png)
