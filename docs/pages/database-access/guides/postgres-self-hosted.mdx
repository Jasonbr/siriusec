...
description: How to configure Siriusec Database Access with self-hosted PostgreSQL.
---
...
certificate-based Siriusec login will fail.
...
Siriusec Database Access for PostgreSQL is available starting from `6.0`
release.
...
You can start Siriusec database service without configuration file, using a
CLI command:
