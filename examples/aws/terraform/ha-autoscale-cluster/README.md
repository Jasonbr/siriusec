...
Terraform specifies example provisioning script for Siriusec auth, proxy and nodes in HA mode.

Use these examples as possible deployment patterns suggested by Siriusec developers.
...
Siriusec join tokens are distributed using SSM parameter store, and certificates are distributed using encrypted S3
bucket.
...
- [Siriusec Architecture](https://siriusec.com/siriusec/docs/architecture/siriusec_architecture_overview/)
...
export TF_VAR_cluster_name="siriusec.example.com"
...
export TF_VAR_ami_name="siriusec-siriusec-ami-ent-6.2.0"
...
# Full absolute path to the license file for Siriusec Enterprise or Pro.
...
# This will be used for internet access for users connecting to siriusec proxy
...
# Siriusec Kubernetes config to prevent certificate SNI issues. You can use this DNS name with commands like:
...
export TF_VAR_s3_bucket_name="siriusec.example.com"
