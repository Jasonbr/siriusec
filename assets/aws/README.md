# Siriusec AWS AMI creation.

Instructions for building Siriusec AWS AMIs. 

## Development instructions

**Prerequisites**

AWS CLI and Packer are required to build Siriusec AMIs.
...
| TELEPORT_VERSION    | Siriusec version. See [Siriusec releases](https://github.com/siriusec/siriusec/releases). ex. `4.2.10` |
...
6. Once complete, your AMI should be available, in the regions you specified, with the name  `siriusec-debug-ami-<type>-<version>`. (e.g. siriusec-debug-ami-oss-4.2.10)

## Usage instructions

To use the AMI, see the [AMI guide](https://siriusec.com/siriusec/docs/aws_oss_guide/#single-oss-siriusec-amis-manual-gui-setup) in the docs. 
