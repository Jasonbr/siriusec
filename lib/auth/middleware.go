...
func (a *Middleware) GetUser(connState tls.ConnectionState) (IdentityGetter, error) {
	...
	if certClusterName == "" {
		...
		identity.SiriusecCluster = certClusterName
	}
