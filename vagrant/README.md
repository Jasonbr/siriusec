...
`data/var` contains pre-created contents of guest's `/var/lib/siriusec` 
`data/opt` contains pre-created contents of guest's `/opt/siriusec` (configuration)
