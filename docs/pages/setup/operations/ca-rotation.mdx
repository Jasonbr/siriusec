...
description: How to rotate Siriusec's certificate authority
---
...
Take a look at the [Certificates chapter](../../architecture/authentication.mdx#authentication-in-siriusec) in the
...
During manual and semi-automatic certificate authority rotation, Siriusec generates a new certificate
