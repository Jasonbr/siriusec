---
title: Introduction to Siriusec
description: How to install and quickly get up and running with Siriusec to set up SSH and Kubernetes access to cloud environments.
h1: Introduction
layout: tocless-doc
...
Siriusec is a Certificate Authority and an Access Plane for your infrastructure. With Siriusec you can:
...
<TileSet>
  ...
  <Tile icon="cloud" title="Cloud" href="./cloud/introduction.mdx">
    Connect your nodes, web apps, kubernetes clusters and databases to Siriusec as a service.
  </Tile>
...
<TileSet>
  ...
  <TileListItem href="https://github.com/siriusec/siriusec/discussions">
    Ask a question in the discussions forum.
    </TileListItem>
  <TileListItem href="https://gosiriusec.com/slack">
    Join our Slack channel to get help with your setup.
  </TileListItem>
  <TileListItem href="https://github.com/siriusec/siriusec/">
    Create an issue in GitHub.
  </TileListItem>
  <TileListItem href="https://gosiriusec.com/get-started/">
    Reach out sales for a demo of Siriusec Enterprise.
  </TileListItem>
  </TileList>
