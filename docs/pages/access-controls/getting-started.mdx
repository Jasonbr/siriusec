...
description: Get started using Siriusec Access Controls.
---

# Getting Started

In Siriusec, any local, SSO, or robot user can be a member of one or several
...
Siriusec provides a [several preset roles](./reference.mdx#preset-roles): `admin`, `editor`, `auditor` and `access`.
...
We're now going to set up a GitHub connector for Siriusec Open Source Edition and Okta for Siriusec Enterprise Edition.
    ...
    spec:
      ...
      teams_to_logins:
        - organization: octocats # Github organization name
          ...
          # map github admin team to Siriusec's "access" role
          logins: ["access"]
    ```
  </TabItem>
