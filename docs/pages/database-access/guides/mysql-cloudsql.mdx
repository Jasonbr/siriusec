...
description: How to configure Siriusec Database Access with GCP Cloud SQL MySQL.
---
...
Siriusec uses one-time passwords to authenticate with Cloud SQL MySQL. To be
able to authenticate with a database instance, Siriusec must run as a service
...
Save the file, your Siriusec Database Service will need to use it as GCP
...
Siriusec Database Access for Cloud SQL MySQL is available starting from `7.0`
release.
