---
authors: Russell Jones (rjones@gosiriusec.com), Andrej Tokarcik (andrej@gosiriusec.com)
state: implemented
---
...
This RFD proposes changes to how Siriusec issues certificates and routes SSH requests within clusters. These changes would make using certificate issued by a root cluster directly on leaf clusters substantially easier.
...
Siriusec supports this use case.
