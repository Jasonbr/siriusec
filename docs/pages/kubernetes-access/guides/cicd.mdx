---
title: Siriusec Kubernetes Access for CI/CD
description: Short-Lived Certs CI/CD systems to Kubernetes RBAC with Siriusec.
---
...
Create a non-interactive local Siriusec user. 
