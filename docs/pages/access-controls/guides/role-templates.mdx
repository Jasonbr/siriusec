...
Let's explore how Siriusec's role templates provide a way to describe these and other policies.
...
attributes during [single sign-on redirect flow](https://gosiriusec.com/blog/how-oidc-authentication-works/):
...
spec:
  ...
  redirect_url: https://siriusec.example.com/v1/webapi/github/callback
...
```code
$ tsh login --proxy=siriusec.example.com --auth=github
...
during single-sign on and present to Siriusec. Let's review a couple of scenarios
and see how Siriusec interpolates the variables.
