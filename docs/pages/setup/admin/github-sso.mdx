...
This guide explains how to set up Github SSO with Open Source, Enterprise Siriusec,
...
spec:
  ...
  teams_to_logins:
    - organization: octocats # Github organization name
      ...
      # maps octocats/admins to siriusec role access
      logins:
        - access
```
...
Siriusec will request only the `read:org` OAuth scope, you can read more about
...
<Admonition type="tip">
  ...
  present in the "teams to logins" mapping, otherwise Siriusec will not be
  able to determine team memberships for these orgs.
</Admonition>

## Step 2/2. Configure authentication preference

Configure Siriusec Auth Service Github for authentication:
...
You can now login with Siriusec using `github` SSO.
