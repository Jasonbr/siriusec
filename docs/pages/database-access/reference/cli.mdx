...
description: CLI reference for Siriusec Database Access.
---
...
Starts Siriusec Database Service agent.
...
| `--host` | Server name to encode in the certificate. Must match the hostname Siriusec will be connecting to the database at. |
