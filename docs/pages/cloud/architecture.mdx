---
title: Siriusec Cloud Architecture
description: Cloud security, availability and networking details.
---

## Security

We have designed the Siriusec Cloud environment to be secure; however we are still in the process of
...
whether the Siriusec Cloud is ready for strict compliance use-cases.

## Compliance

(!docs/pages/includes/soc2.mdx!)

## Managed Siriusec Settings

SSH sessions are recorded [on nodes](../architecture/nodes.mdx#session-recording).
Siriusec Cloud Proxy does not terminate SSH sessions when using OpenSSH and `tsh` sessions.
