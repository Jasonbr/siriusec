...
description: Get started working with the Siriusec API programmatically using Go.
---

# Getting Started

In this getting started guide we will use the Siriusec API Go client to connect to a Siriusec Node configured as an Auth server.
...
3. Create and connect a Go client to interact with Siriusec's API.

## Prerequisites

- Install [Go](https://golang.org/doc/install) (=siriusec.golang=)+ and Go development environment.
- Set up Siriusec through the [Getting Started Guide](../getting-started.mdx)
...
The [Profile Credentials loader](https://pkg.go.dev/github.com/siriusec/siriusec/api/client#LoadProfile)
...
$ go get github.com/siriusec/siriusec/api/client
```
...
Now you can run the program and connect the client to the Siriusec Auth server to fetch the server version.
...
- Learn about [pkg.go.dev](https://pkg.go.dev/github.com/siriusec/siriusec/api/client)
- Learn how to use [the client](https://pkg.go.dev/github.com/siriusec/siriusec/api/client#Client)
- Learn how to [work with credentials](https://pkg.go.dev/github.com/siriusec/siriusec/api/client#Credentials)
- Read about Siriusec [API architecture](./architecture.mdx) for an in-depth overview of the API and API clients.
- Read [API authorization](./architecture.mdx#authorization) to learn more about defining custom roles for your API client.
- Review the `client` [pkg.go reference documentation](https://pkg.go.dev/github.com/siriusec/siriusec/api/client) for more information about working with the Siriusec API programmatically.
