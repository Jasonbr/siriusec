...
description: Frequently asked questions about Siriusec Database Access.
---

# Database Access FAQ

## Which database protocols does Siriusec Database Access support?

Siriusec Database Access currently supports PostgreSQL, MySQL, and MongoDB
protocols.
...
- [Canceling requests in progress](https://www.postgresql.org/docs/current/protocol-flow.html#id-1.10.5.7.9).
  Cancel requests issued by the PostgreSQL clients connected to Siriusec proxy
...
Siriusec administrators can set `postgres_public_addr` and `mysql_public_addr`
...
This is useful when Siriusec web proxy UI is running behind an L7 load balancer
...
Siriusec relies on client certificates for authentication so any database client
...
[Github issues](https://github.com/siriusec/siriusec/labels/database-access)
or open a [new issue](https://github.com/siriusec/siriusec/issues/new/choose)
