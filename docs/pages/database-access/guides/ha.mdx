...
description: How to configure Siriusec Database Access in a Highly Available (HA) configuration.
---
...
When connecting, Siriusec will randomly pick the service to connect through to
provide some load balancing. If the selected agent is down (e.g. in case of AZ
outage), Siriusec will try to connect via other agents.
