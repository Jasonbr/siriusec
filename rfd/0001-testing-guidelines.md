...
Guidelines for writing Go tests for siriusec.

## Why

At the time of writing this, siriusec tests use
...
Re-writing all of siriusec tests is a large task. To make it feasible,
...
func TestMain(m *testing.M) {
	...
	tmpDir, err := ioutil.TempDir("", "siriusec")
	if err != nil {
